...
- **Biomas** (desierto y tundra): un segundo ruido de baja frecuencia clasifica cada columna — las zonas de **desierto** tienen arena en superficie y sin árboles; las de **tundra** llevan una capa de **nieve** (bloque nuevo, id 33, blanco) y sin árboles; el resto es llanura/bosque normal. La nieve tiene color, icono y nombre en el idioma.
